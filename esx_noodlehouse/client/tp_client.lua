...
positions = {
    {{-655.22, -880.10, 24.65, 0}, {-657.14, -880.31, 24.69, 0},{255,255,0}, "[E] NoodleHouse"},
...
Citizen.CreateThread(function ()
    while true do
        ...
        for _,location in ipairs(positions) do
            ...
            DrawMarker(21, loc1.x, loc1.y, loc1.z, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 0.5, Red, Green, Blue, 200, 0, 0, 0, 0)
            DrawMarker(21, loc2.x, loc2.y, loc2.z, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 0.5, Red, Green, Blue, 200, 0, 0, 0, 0)
