...
--RegisterNetEvent("esx_chasse:createBlip")
--AddEventHandler("esx_chasse:createBlip", function(type, x, y, z)
...
--		AddTextComponentString("esx_chasse")
--		EndTextCommandSetBlipName(blip)
--	end
--end)

RegisterNetEvent("esx_noodlehouse:createBlip2")
AddEventHandler("esx_noodlehouse:createBlip2", function(type, x, y, z)
	local blip = AddBlipForCoord(x, y, z)
	SetBlipSprite(blip, type)
	SetBlipScale(blip, 0.8)
	SetBlipAsShortRange(blip, true)
	if(type == 52)then
		BeginTextCommandSetBlipName("STRING")
		AddTextComponentString("Vente de Ramen")
		EndTextCommandSetBlipName(blip)
	end
end)
------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------
Citizen.CreateThread(function()
		--TriggerEvent('esx_chasse:createBlip', 141, -1492.2, 4971.5, 64.2)
		TriggerEvent('esx_noodlehouse:createBlip2', 52, 868.07,-1640.26,30.33)
    ...
    while true do
       ...
       --playerPed = GetPlayerPed(-1)
		...
		if pos then
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), 868.07, -1640.26, 30.33, true) <= 5 then
					TriggerServerEvent('esx_noodlehouse:startVente')
					Citizen.Wait(1000)
				end
				...
				--	drawTxt("Press 'Utiliser / E' pour commencer a esx_chasser ou pour ARRETER",0,1,0.5,0.8,0.6,255,255,255,255)
...
--				--					RemoveBlip(entityBlip[proie])
--				--					Citizen.InvokeNative(0xAE3CBE5BF394C9C9, Citizen.PointerValueIntInitialized(entity[proie]))
--				--					TriggerServerEvent('esx_chasse:startRecup')
